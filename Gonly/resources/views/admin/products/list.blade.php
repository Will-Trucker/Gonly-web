                ...
                <form action="" method="get">
                    <div class="card-header">
                      <div class="card-title">
                        <button type="button" onclick="window.location.href='{{ route("products.index") }}'" class="btn btn-default btn-sm">{{__('Reset')}}</button>
                      </div>
                        ...
                        <tbody>
                            @if ($products->isNotEmpty())
                                ...
                                <td>
                                    ...
                                    @else
                                    <img src="{{ Vite::asset('resources/img/default-150x150.png') }}" class="img-thumbnail" width="50">
                                    @endif
                                </td>
                                <td>{{ $product->title }}</td>
                                <td>${{ $product->price }}</td>
                                <td>{{ $product->qty }} {{__('In stock')}}</td>
                                <td>{{ $product->sku}}</td>											
                                <td>
                                    @if ($product->status == 1)
