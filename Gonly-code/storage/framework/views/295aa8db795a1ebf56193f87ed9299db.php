...
<body style="background-image: url(<?php echo e(Vite::asset('resources/img/Decoration/circle-scatter-haikei.svg')); ?>);">
    
    <div class="form-container">
        <form method="POST" action="<?php echo e(route('register')); ?>" class="form-register">
            <?php echo csrf_field(); ?>
            <div class="logo-img">
...
<?php endif; ?>
            ...
            <div class="container-input-and-login">
                ...
                <h5>Ya tienes una cuenta? <a href="<?php echo e(Route('login')); ?>">Iniciar seción.</a></h5>
            </div>
        </form>
        <div class="form-decoration">
             <img src="<?php echo e(Vite::asset('resources/img/Decoration/register.png')); ?>">
        </div>
    </div>

</body>
</html>
<?php /**PATH C:\Users\diego\OneDrive\Documentos\GitHub\Gonly-web\Gonly-code\resources\views/auth/register.blade.php ENDPATH**/ ?>